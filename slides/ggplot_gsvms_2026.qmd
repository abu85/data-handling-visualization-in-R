---
title: "`ggplot2` in `R` Part 1 & 2"
description: "Slides modified from Roy Francis (RaukR 2023)"
...
## Scales • `CVD friendly colors (palettes)` 
-   scales: position, `color`, fill, size, shape, alpha, linetype
-   syntax: `scale_<aesthetic>_<type>` 
...
library(RColorBrewer)  # you must have this package
